export const questions = [
  ...
  {
    "prompt": "Match each description to its corresponding term. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "message encapsulation",
        "desc": "the process of placing one message format inside another message format"
      },
      {
        "id": "1",
        "term": "message sizing",
        "desc": "the process of breaking up a long message into individual pieces before being sent over the network"
      },
      {
        "id": "2",
        "term": "message encoding",
        "desc": "the process of converting information from one format into another acceptable for transmission"
      }
    ],
    "img": "https://itexamanswers.net/wp-content/uploads/2020/01/17.jpg",
    "type": "match"
  },
  {
  ...
  {
    "prompt": "Match each description with the corresponding TCP mechanism. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "number of bytes a destination device can accept and process at one time",
        "desc": "window size"
      },
      {
        "id": "1",
        "term": "used to identify missing segments of data",
        "desc": "sequence numbers"
      },
      {
        "id": "2",
        "term": "method of managing segments of data loss",
        "desc": "retransmission"
      },
      {
        "id": "3",
        "term": "received by a sender before transmitting more segments in a session",
        "desc": "acknowledgment"
      }
    ],
    "img": null,
  ...
  {
    "prompt": "Match each item to the type of topology diagram on which it is typically identified. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "location of a desktop PC in a classroom",
        "desc": "physical topology diagram"
      },
      {
        "id": "1",
        "term": "path of cables that connect rooms to wiring closets",
        "desc": "physical topology diagram"
      },
      {
        "id": "2",
        "term": "IP address of a server",
        "desc": "logical topology diagram"
      }
    ],
    "img": null,
    "type": "match"
  ...
  {
    "prompt": "Match the type of threat with the cause. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "electrical threats",
        "desc": "voltage spikes, insufficient supply voltage (brownouts), unconditioned power (noise), and total power loss"
      },
      {
        "id": "1",
        "term": "hardware threats",
        "desc": "physical damage to servers, routers, switches, cabling plant, and workstations"
      },
      {
        "id": "2",
        "term": "environmental threats",
        "desc": "temperature extremes (too hot or too cold) or humidity extremes (too wet or too dry)"
      },
      {
        "id": "3",
        "term": "maintenance threats",
        "desc": "poor handling of key electrical components (electrostatic discharge), lack of critical spare parts, poor cabling, and poor labeling"
      }
    ],
    "img": null,
    "type": "match"
  ...
  {
    "prompt": "Match a statement to the related network model. (Not all options are used.) ",
    "pairs": [
      {
        "id": "0",
        "term": "no dedicated server is required ",
        "desc": "peer-to-peer network"
      },
      {
        "id": "1",
        "term": "client and server roles are set on a per request basis",
        "desc": "peer-to-peer network"
      },
      {
        "id": "2",
        "term": "requires a specific user interface",
        "desc": "peer-to-peer aplication"
      },
      {
        "id": "3",
        "term": "a background service is required",
        "desc": "peer-to-peer aplication"
      }
    ],
    "img": null,
  ...
  {
    "prompt": "Match each type of frame field to its function. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "addressing",
        "desc": "This field helps to direct the frame toward its destination."
      },
      {
        "id": "1",
        "term": "error detection",
        "desc": "This field checks if the frame has been damaged during the transfer."
      },
      {
        "id": "2",
        "term": "type",
        "desc": "This field is used by the LLC to identify the Layer 3 protocol."
      },
      {
        "id": "3",
        "term": "frame start",
        "desc": "This field identifies the beginning of a frame."
      }
    ],
    "img": null,
    "type": "match"
  ...
  {
    "prompt": "Match the firewall function to the type of threat protection it provides to the network. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "prevents access by port number",
        "desc": "application filtering"
      },
      {
        "id": "1",
        "term": "prevents access based on IP or MAC address",
        "desc": "packet filtering"
      },
      {
        "id": "2",
        "term": "prevents unsolicited incoming sessions",
        "desc": "stateful packet inspection"
      },
      {
        "id": "3",
        "term": "prevents access to websites",
        "desc": "URL filtering"
      }
    ],
    "img": null,
  ...
  {
    "prompt": "Match the characteristic to the category. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "contained in the Layer 3 header",
        "desc": "IP address"
      },
      {
        "id": "1",
        "term": "separated into a network portion and a unique identifier",
        "desc": "IP address"
      },
      {
        "id": "2",
      ...
      {
        "id": "3",
        "term": "contained in the Layer 2 header",
        "desc": "MAC address"
      },
      {
        "id": "4",
        "term": "separated into OUI and a unique identifier",
        "desc": "MAC address"
      },
      {
        "id": "5",
  ...
  {
    "prompt": "Match the description to the IPv6 addressing component. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "This network portion of the address is assigned by the provider.",
        "desc": "global routing"
      },
      {
        "id": "1",
        "term": "This part of the address is used by an organization to identify subnets.",
        "desc": "subnet ID"
      },
      {
        "id": "2",
        "term": "This part of the address is the equivalent to the host portion of an IPv4 address.",
        "desc": "interface ID"
      }
    ],
    "img": null,
  ...
  {
    "prompt": "Match the characteristic to the forwarding method. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "low latency",
      ...
      {
        "id": "1",
        "term": "may forward runt frames",
        "desc": "Cut-through"
      },
      {
        "id": "2",
        "term": "begins forwarding when the destination address is received",
        "desc": "Cut-through"
      },
      {
        "id": "3",
        "term": "always stores the entire frame",
        "desc": "Store-and-forward"
      },
      {
        "id": "4",
        "term": "checks the CRC before forwarding",
        "desc": "Store-and-forward"
      },
      {
        "id": "5",
        "term": "checks the frame length before forwarding",
        "desc": "Store-and-forward"
      }
    ],
    "img": null,
  ...
  {
    "prompt": "Refer to the exhibit. Match the network with the correct IP address and prefix that will satisfy the usable host addressing requirements for each network. (Not all options are used.)  ",
    "pairs": [
      {
        "id": "0",
        "term": "Network A",
  ...
  {
    "prompt": "Match the application protocols to the correct transport protocols",
    "pairs": [
      {
        "id": "0",
        "term": "FTP",
  ...
  {
    "prompt": "Match the header field with the appropriate layer of the OSI model. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "802.2 header",
