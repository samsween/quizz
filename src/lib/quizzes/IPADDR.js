export const questions = [
  ...
  {
    "prompt": "Match the subnetwork to a host address that would be included within the subnetwork. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "192.168.1.32/27",
        "desc": "192.168.1.48"
      },
      {
        "id": "1",
        "term": "192.168.1.64/27",
        "desc": "192.168.1.68"
      },
      {
        "id": "2",
        "term": "192.168.1.96/27",
        "desc": "192.168.1.121"
      }
    ],
    "img": null,
  ...
  {
    "prompt": "Match each IPv4 address to the appropriate address category. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "192.168.100.161/25",
        "desc": "Host Address"
      },
      {
        "id": "1",
        "term": "192.168.1.191/26",
        "desc": "Broadcast Address"
      },
      {
        "id": "2",
        "term": "10.10.10.128/25",
        "desc": "Network Address"
      },
      {
        "id": "3",
        "term": "203.0.113.100/24",
        "desc": "Host Address"
      },
      {
        "id": "4",
  ...
  },
  {
    ...
    "img": "https://itexamanswers.net/wp-content/uploads/2020/01/i271962v1n1_211100.png",
    "type": "mcq"
  },
  {
  ...
  },
  {
    ...
    "img": "https://itexamanswers.net/wp-content/uploads/2020/01/i274512v1n1_274512-300x251-1.png",
    "type": "mcq"
  },
  {
  ...
  {
    "prompt": "Refer to the exhibit. Match the network with the correct IP address and prefix that will satisfy the usable host addressing requirements for each network.",
    "pairs": [
      {
        "id": "0",
        "term": "Network D",
        "desc": "192.168.0.80 /30"
      },
      {
        "id": "1",
        "term": "Network A",
        "desc": "192.168.0.128 /25"
      },
      {
        "id": "2",
        "term": "Network B",
  ...
  {
    "question": " Consider the following range of addresses: 2001:0DB8:BC15:00A0:0000:: 2001:0DB8:BC15:00A1:0000:: 2001:0DB8:BC15:00A2:0000:: … 2001:0DB8:BC15:00AF:0000:: The prefix-length for the range of addresses is ___ ",
    "answers": [
      "/60"
    ],
    "correct": [
  ...
  },
  {
    ...
    "img": "https://itexamanswers.net/wp-content/uploads/2020/01/i247454v1n1_207631-300x203-1.png",
    "type": "mcq"
  },
  {
  ...
  {
    "prompt": "Match the IPv6 address with the IPv6 address type. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "::1",
      ...
      },
      {
        "id": "1",
        "term": "FF02::1",
        "desc": "all node multicast"
      },
      {
        "id": "2",
        "term": "FF02::1:FFAE:F85F",
        "desc": "solicited node multicast"
      },
      {
        "id": "3",
        "term": "2001:DB8::BAF:3F57:FE94",
        "desc": "global unicast"
      }
    ],
    "img": null,
  ...
  {
    "prompt": "Three methods allow IPv6 and IPv4 to co-exist. Match each method with its description. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "The IPv4 packets and IPv6 packets coexist in the same network.",
        "desc": "dual-stack"
      },
      {
        "id": "1",
  ...
  },
  {
    ...
    "img": "https://itexamanswers.net/wp-content/uploads/2020/01/i210352v1n3_210352.png",
    "type": "mcq"
  },
  {
  ...
  {
    "prompt": "Match each description with an appropriate IP address. (Not all options are used.)",
    "pairs": [
      {
        "id": "0",
        "term": "a link-local address",
        "desc": "169.254.1.5"
      },
      {
        "id": "1",
      ...
      {
        "id": "2",
        "term": "an experimental address",
        "desc": "240.2.6.255"
      },
      {
        "id": "3",
        "term": "a private address",
        "desc": "172.19.20.5"
      },
      {
        "id": "4",
        "term": "a loopback address",
        "desc": "127.0.0.1"
      }
    ],
    "img": null,
  ...
  },
  {
    ...
    "img": "https://itexamanswers.net/wp-content/uploads/2019/12/CCNA-1-v7-Modules-11-13-IP-Addressing-Exam-Answers-Full.jpg",
    "type": "mcq"
  },
  {
